...
if __name__ == '__main__':
    ...
    for xml_path, output_path in (
        (os.path.join(ARQM_TASK1_PATH, "Topics_V2.0.xml"), TASK1_TOPICS[2020]),
        (os.path.join(ARQM_TASK1_PATH, "Topics_Task1_2021_V1.1.xml"), TASK1_TOPICS[2021]),
        (os.path.join(ARQM_TASK1_PATH, "Topics_Task1_2022_V0.1.xml"), TASK1_TOPICS[2022]),
    ):
    ...
    #### Task2
    for xml_path, output_path in (
        (os.path.join(ARQM_TASK2_PATH, "Topics_V1.1.xml"), TASK2_TOPICS[2020]),
        (os.path.join(ARQM_TASK2_PATH, "Topics_Task2_2021_V1.1.xml"), TASK2_TOPICS[2021]),
        (os.path.join(ARQM_TASK2_PATH, "Topics_Task2_2022_V0.1.xml"), TASK2_TOPICS[2022]),
    ):
        topics_xml2json(xml_path, output_path)
    for year in (2020, 2021, 2022):
